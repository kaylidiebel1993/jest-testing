...
test('capitalize a sentence with punctuation', () => {
    expect(capitalize('this is a sentence.')).toBe('This is a sentence.'); 
}); 

test('capitalize a sentence with punctuation at the beginning of the sentence', () => {
    expect(capitalize('*this" is a sentence.')).toBe('*This* is a sentence.'); 
}); 
...
test('reversing a sentence', () => {
    expect(reverseString('This is a whole sentence.')).toBe('.ecnatnes elohw a si sihT'); 
}); 
...
test('multplicaiton of -12 and 34 is 46', () => {
    expect(new Calculator(-12, 34).multiply()).toBe(-408); 
}); 
...
test('caesar shift of 1 for "apple" returns "bqqmf"', () => {
    expect(caesar('apple', )).toBe('bqqmf'); 
}); 
...
test('caesar shift of -5 for "fuuqj" returns "apple"', () => {
    expect(caesar('fuuqf', -5)).toBe('apple'); 
}); 
